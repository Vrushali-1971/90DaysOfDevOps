...
2. 'echo "Today is Day-6 of 90 days of Devops challenge" > notes.txt'
 
     Wrote text to the file using '>' (Overwrites existing content).
   
3. 'echo "This task is to practice basic file read/write using fundamental commands" >> notes.txt'
 
    Appended a new line to the file using '>>'.
   
4. 'echo "Let's do this task" | tee -a notes.txt'
